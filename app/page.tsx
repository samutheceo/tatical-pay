        ...
        <Squircle cornerRadius={25} cornerSmoothing={0.6} asChild className='w-fit h-fit px-8 py-4 bg-white/30 backdrop-blur-sm flex flex-col items-center justify-center md:scale-[1] scale-[0.9]'>
          <section className='w-fit h-fit flex flex-col items-center justify-center text-center gap-y-2'>
            ...
            <div className='flex flex-col gap-y-2 mt-4 border-solid border-t-[1px] border-zinc-500 py-4'>
              ...
              {showCryptoAddress ? (
                <div className='text-[0.7rem] flex text-center items-center justify-center font-mono text-zinc-500 bg-zinc-800 rounded-lg w-72 h-fit px-4 py-2 select-text'>
                  0x590d869457390dcf0b8dbf7ef4f5810d4be4d3b8
                </div>
              ) : (
                <Squircle onClick={handleCryptClick} cornerRadius={13} cornerSmoothing={0.6} asChild className='w-72 h-fit bg-orange-500 text-white text-sm px-4 py-2 flex items-center justify-center cursor-pointer transition-all duration-200 ease-linear hover:opacity-60'>
                  <span className='flex flex-wrap gap-x-2'>
